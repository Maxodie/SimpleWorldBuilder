...
public:
    ...
    void UpdateModelMatrix()
    {
        ...
        // m_modelMat = glm::rotate(m_modelMat, glm::radians(m_rotation.x), glm::vec3(1,0,0));
        // m_modelMat = glm::rotate(m_modelMat, glm::radians(m_rotation.y), glm::vec3(0,1,0));
        // m_modelMat = glm::rotate(m_modelMat, glm::radians(m_rotation.z), glm::vec3(0,0,1));
        m_modelMat *= glm::toMat4(glm::quat(m_rotation));
    ...
    const glm::vec3& GetLeft()
    {
        ...
        // m_forward = glm::normalize(glm::vec3(glm::inverse(transform)[0]));
        m_forward = glm::normalize(glm::vec3((transform)[0]));
    ...
    const glm::vec3& GetUp()
    {
        ...
        m_up = glm::normalize(glm::vec3((transform)[1]));
    ...
    WB_INLINE void Rotate(const glm::quat& rotation) { m_rotation = glm::eulerAngles(glm::quat(m_rotation) * glm::quat(rotation)); }
